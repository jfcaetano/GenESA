...
model_filename = '/content/drive/MyDrive/model_run/03-GPT_decriptor_to_smiles_model.pth'
vocab_filename = '/content/drive/MyDrive/model_run/03-GPT-vocabulary.pth'
...
output_path = '/content/drive/MyDrive/model_run/03-GPT-Generated_SMILES.csv'

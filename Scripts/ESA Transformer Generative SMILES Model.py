...
model_filename = '/content/drive/MyDrive/model_run/02-Trn-descriptor_to_smiles_model.pth'
vocab_filename = '/content/drive/MyDrive/model_run/02-Trn-vocabulary.pth'
...
# Save results
output_path = '/content/drive/MyDrive/model_run/02-Trn-Generated_SMILES.csv'
